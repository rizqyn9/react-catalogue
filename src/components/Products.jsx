...
const Product = (props) => {
    const {Title, Desc, Image, Category, Admin, Properties} = props
        ...
        if(Admin) {
            return (
                <div className="flex-auto flex w-full h-full">
                    ...
                    <div className="flex-auto h-full w-full flex justify-center items-center cursor-pointer hover:bg-green-500 hover:text-green-50 select-none "><a href="/"> Ubah</a></div>
                </div>
            )
        } else {
            ...
            <div className=" flex-auto flex overflow-hidden border-b-2 border-green-400">
                <div className={`slider flex ${activated ? 'translate' : ''}`}>
                    ...
                    <div className=" flex flex-col  h-full width_inner p-4 items-center justify-center">
                        ...
                        <div className="wrapper whitespace-normal flex-auto bg-red-200">
                            {Desc}
                        </div>
                        <div>
                                {/* {
